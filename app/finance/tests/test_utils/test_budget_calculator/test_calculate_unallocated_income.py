...
class CalculateUnallocatedIncomeTests(TestCase):
    ...
    def test_normal_scenario_with_partial_allocation(self):
        ...
        result = calculate_unallocated_income(transactions, budgets)
    ...
    def test_no_budgets_all_unallocated(self):
        Transaction.objects.create(
            user=self.user,
            type=TransactionType.INCOME.name,
            category="Salary",
    ...
    def test_no_income_with_budgets(self):
        Budget.objects.create(
            user=self.user,
            type=TransactionType.NEED.name,
            category="Rent",
    ...
    def test_excludes_income_type_budgets(self):
        Transaction.objects.create(
            user=self.user,
            type=TransactionType.INCOME.name,
            category="Salary",
